...
async def zed_handler(zedub):
    ...
    if query.startswith("زدثون") and zedub.query.user_id == bot.uid:
        channels = f"**•❐• مـرحبــاً عـزيـزي  {mention} **\n**•❐• اليـك مجمـوعــة قنـوات ريبثون ↵ R𝙀𝙋𝙏𝙃𝙊𝙉𖠏 ♥️🦾**\n\n**•❐• استـخـدم الازرار بالاسفــل↓**"
        buttons = [[Button.url("قنـاة السـورس", "https://t.me/Repthon"),],[Button.url("التحـديثـات", "https://t.me/Repthon_up"), Button.url("الفـارات", "https://t.me/Repthon_vars"),],[Button.url("الشـروحـات¹", "https://t.me/Repthonn"),],[Button.url("الشـروحـات²", "https://t.me/Repthonn"),],[Button.url("مطـور السـورس", "https://t.me/ZQ_LO"),]]
