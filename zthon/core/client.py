                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @a_t_9\
                                  \n\n--------بـدء تتبـع سجـل ببيـثون 𝗕𝗧𝗛𝗢𝗡--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع ببيـثون 𝗕𝗧𝗛𝗢𝗡--------"
                        ...
                        link = "[بـلاك](https://t.me/a_t_9)"
                        text = (
                            "**✘ تقـريـر خطـأ ببيـثون 𝗕𝗧𝗛𝗢𝗡 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر خطـأ ببيـثون 𝗕𝗧𝗛𝗢𝗡**\n\n"
                        link = "[بـلاك](https://t.me/a_t_9)"
