...
async def _(event):
    "Shutdowns the bot"
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#ايقــاف البــوت\n\n" "**- بـوت ببيـثون فـي وضــع الايقــاف**")
    await edit_or_reply(event, "**⌔∮جــارِ إيقـاف تشغيـل بـوت ببيـثون الآن 📟 ... شغِّـلنـي يـدويًـا لاحقًــا**")
