...
async def update_bot(event, repo, ups_rem, ac_br):
    ...
    sandy = await event.edit(f"𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 R𝙀𝙋𝙏𝙃𝙊𝙉𖠏 **- تحـديثـات السـورس** 𓆪\n**•─────────────────•**\n\n**•⎆┊تم التحـديث ⎌ بنجـاح ☑️**\n**•⎆┊جـارِ إعـادة تشغيـل بـوت ريبثون ⎋ انتظـر مـن 2 - 1 دقيقـه . . .𓆰**")
    await event.client.reload(sandy)


async def deploy(event, repo, ups_rem, ac_br, txt):
    if HEROKU_API_KEY is None:
        return await event.edit(f"𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 R𝙀𝙋𝙏𝙃𝙊𝙉𖠏 - تحـديثـات السـورس](t.me/Repthon) 𓆪\n **•─────────────────•**\n** ⪼ لم تقـم بوضـع مربـع فـار HEROKU_API_KEY اثنـاء التنصيب وهـذا خطـأ .. قم بضبـط المتغيـر أولاً لتحديث بوت ريبثون ..؟!𓆰**")
    heroku = heroku3.from_key(HEROKU_API_KEY)
    heroku_applications = heroku.apps()
    if HEROKU_APP_NAME is None:
        await event.edit(f"𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 R𝙀𝙋𝙏𝙃𝙊𝙉𖠏 - تحـديثـات السـورس](t.me/Repthon) 𓆪\n **•─────────────────•**\n** ⪼ لم تقـم بوضـع مربـع فـار HEROKU_APP_NAME اثنـاء التنصيب وهـذا خطـأ .. قم بضبـط المتغيـر أولاً لتحديث بوت ريبثون ..؟!𓆰**")
        repo.__del__()
        return
    heroku_app = next(
...
async def upstream(event):
    ...
    if ENV and (HEROKU_API_KEY is None or HEROKU_APP_NAME is None):
        return await edit_or_reply(
            event, f"𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 R𝙀𝙋𝙏𝙃𝙊𝙉𖠏 - تحـديثـات السـورس](t.me/Repthon) 𓆪\n**•─────────────────•**\n** ⪼ اضبط الفـارات المطلوبة أولاً لتحديث بوت ريبثون 𓆰،**"
        )
    try:
        txt = (
    ...
    if changelog == "" and not force_update:
        await event.edit(
            f"\n𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 R𝙀𝙋𝙏𝙃𝙊𝙉𖠏 - تحـديثـات السـورس](t.me/Repthon) 𓆪\n**•─────────────────•**\n\n**⪼ سـورس ريبثون محـدث لـ آخـر إصـدار 🛂**"
        )
        return repo.__del__()
    if conf == "" and not force_update:
        return await edit_or_reply(event, f"𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 R𝙀𝙋𝙏𝙃𝙊𝙉𖠏 - تحـديثـات السـورس](t.me/Repthon) 𓆪\n**•─────────────────•**\n\n**•⎆┊يوجـد تحـديث جديـد لسـورس ريبثون ༗...**\n\n**•⎆┊للتحديث السريع اضغـط هنـا ⇜** ⦉ `{cmdhd}تحديث الان` ⦊ \n**•⎆┊للتحديث الجـذري اضغـط هنـا ⇜** ⦉ `{cmdhd}تحديث البوت` ⦊ \n\n𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 R𝙀𝙋𝙏𝙃𝙊𝙉𖠏](t.me/Repthon) 𓆪")
    if force_update:
        await event.edit(
            "`Force-Syncing to latest stable userbot code, please wait...`"
        )
    if conf == "الان":
        await event.edit(f"𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 R𝙀𝙋𝙏𝙃𝙊𝙉𖠏 - تحـديثـات السـورس](t.me/Repthon) 𓆪\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ريبثون .. انتظـر . . .🌐𓆰**")
        await asyncio.sleep(1)
        await event.edit("𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 R𝙀𝙋𝙏𝙃𝙊𝙉𖠏 - تحـديثـات السـورس](t.me/Repthon) 𓆪\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ريبثون .. انتظـر . . .🌐𓆰**\n\n%𝟷𝟶 ▬▭▭▭▭▭▭▭▭▭")
        await asyncio.sleep(1)
        await event.edit("𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 R𝙀𝙋𝙏𝙃𝙊𝙉𖠏 - تحـديثـات السـورس](t.me/Repthon) 𓆪\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ريبثون .. انتظـر . . .🌐𓆰**\n\n%𝟸𝟶 ▬▬▭▭▭▭▭▭▭▭")
        await asyncio.sleep(1)
        await event.edit("𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 R𝙀𝙋𝙏𝙃𝙊𝙉𖠏 - تحـديثـات السـورس](t.me/Repthon) 𓆪\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ريبثون .. انتظـر . . .🌐𓆰**\n\n%𝟹𝟶 ▬▬▬▭▭▭▭▭▭▭")
