...
async def deploy(event, repo, ups_rem, ac_br, txt):
    ...
    if heroku_app is None:
        await event.edit(
            f"{txt}\n" "**- بيانات اعتماد هيروكو غير صالحة لتنصيب تحديث ببيـثون**"
        )
        return repo.__del__()
    sandy = await event.edit(f"𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝗕𝗧𝗛𝗢𝗡 - تحـديثـات السـورس](t.me/BThon) 𓆪\n**•─────────────────•**\n\n**✾╎جـارِ . . تنصـيب التحـديث الجـذري ⎌**\n**✾╎يـرجى الانتظـار حتى تنتـهي العمليـة ⎋**\n**✾╎عادة ما يستغرق هـذا التحديث من 5 - 4 دقائـق 📟**")
    try:
...
async def upstream(event):
    ...
    event = await edit_or_reply(event, f"𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝗕𝗧𝗛𝗢𝗡 - تحـديثـات السـورس](t.me/BThon) 𓆪\n**•─────────────────•**\n**⪼ جاري البحث عن التحديثات  🌐.. 𓆰،**")
    off_repo = UPSTREAM_REPO_URL
    force_update = False
    if ENV and (HEROKU_API_KEY is None or HEROKU_APP_NAME is None):
        return await edit_or_reply(
            event, f"𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝗕𝗧𝗛𝗢𝗡 - تحـديثـات السـورس](t.me/BThon) 𓆪\n**•─────────────────•**\n** ⪼ اضبط الفـارات المطلوبة أولاً لتحديث بوت ببيـثون،**"
        )
    try:
        txt = (
    ...
    if changelog == "" and not force_update:
        await event.edit(
            f"\n𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝗕𝗧𝗛𝗢𝗡 - تحـديثـات السـورس](t.me/BThon) 𓆪\n**•─────────────────•**\n\n**⪼ سـورس ريبـــثون محـدث لـ آخـر إصـدار 🛂**"
        )
        return repo.__del__()
    if conf == "" and not force_update:
        return await edit_or_reply(event, f"𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝗕𝗧𝗛𝗢𝗡 - تحـديثـات السـورس](t.me/BThon) 𓆪\n**•─────────────────•**\n\n**•⎆┊يوجـد تحـديث جديـد لسـورس ريبـــثون༗...**\n\n**•⎆┊للتحديث السريع اضغـط هنـا ⇜** ⦉ `{cmdhd}تحديث الان` ⦊ \n**•⎆┊للتحديث الجـذري اضغـط هنـا ⇜** ⦉ `{cmdhd}تحديث البوت` ⦊ \n\n𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝗕𝗧𝗛𝗢𝗡](t.me/BThon) 𓆪")
    if force_update:
        await event.edit(
            "`Force-Syncing to latest stable userbot code, please wait...`"
        )
    if conf == "الان":
        await event.edit(f"𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝗕𝗧𝗛𝗢𝗡 - تحـديثـات السـورس](t.me/BThon) 𓆪\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ببيـثون .. انتظـر . . .🌐𓆰**")
        await asyncio.sleep(1)
        await event.edit("𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝗕𝗧𝗛𝗢𝗡 - تحـديثـات السـورس](t.me/BThon) 𓆪\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ببيـثون .. انتظـر . . .🌐𓆰**\n\n%𝟷𝟶 ▬▭▭▭▭▭▭▭▭▭")
        await asyncio.sleep(1)
        await event.edit("𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝗕𝗧𝗛𝗢𝗡 - تحـديثـات السـورس](t.me/BThon) 𓆪\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ببيـثون .. انتظـر . . .🌐𓆰**\n\n%𝟸𝟶 ▬▬▭▭▭▭▭▭▭▭")
        await asyncio.sleep(1)
        await event.edit("𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝗕𝗧𝗛𝗢𝗡 - تحـديثـات السـورس](t.me/BThon) 𓆪\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ببيـثون .. انتظـر . . .🌐𓆰**\n\n%𝟹𝟶 ▬▬▬▭▭▭▭▭▭▭")
...
async def upstream(event):
    ...
    off_repo = "https://github.com/BT-hon/BThon"
    os.chdir("/app")
    try:
        txt = (
