...
async def _(event):
    await event.edit(
        """
**أوامـر الـصـيـد الخـاصة بــســورس ببيـثون**: 
        ...
        if isav == True:
            try:
                ...
                await event.client.send_file(
                    ...
                    caption="🐊 BThon the best 🐊\n- - - - - - - - - - - - - - - - - - - - - - - -\n- UserName: ❲ @{} ❳\n- ClickS: ❲ {} ❳\n- Type: {}\n- Save: ❲ Chaneel ❳\n- - - - - - - - - - - - - - - - - - - - - - - -\nThE KiNgS ❲ @BThon - @a_t_9 ❳ ".format(
...
async def _(event):
    ...
    try:
        ...
        try:
            ch = await zedub(
                functions.channels.CreateChannelRequest(
                    title="BTHON HUNTER - تثبيت بيثون",
                    about="This channel to hunt username by - @BThon",
                )
            )
            ch = ch.updates[1].channel_id
