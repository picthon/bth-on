                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\n--------بـدء تتبـع سجـل ريبثون 𝑹𝑬𝑷𝑻𝑯𝑶𝑵🜑--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع ريبثون 𝑹𝑬𝑷𝑻𝑯𝑶𝑵🜑--------"
                        ...
                        link = "[𐇮 ✗ ¦ ↱𝐺𝑜𝑙 𝐷. 𝑅𝑜𝑔𝑒𝑟↲ ¦ ✗  𐇮](https://t.me/ZQ_LO)"
                        text = (
                            "**✘ تقـريـر خطـأ ريبثون 𝑹𝑬𝑷𝑻𝑯𝑶𝑵🜑 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر خطـأ ريبثون 𝑹𝑬𝑷𝑻𝑯𝑶𝑵🜑 ✘**\n\n"
                        link = "[𐇮 ✗ ¦ ↱𝐺𝑜𝑙 𝐷. 𝑅𝑜𝑔𝑒𝑟↲ ¦ ✗  𐇮](https://t.me/ZQ_LO)"
